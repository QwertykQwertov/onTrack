...
export const NAV_ITEMS = [{ page: PAGE_TIMELINE, icon: ICON_CLOCK }, { page: PAGE_ACTIVITIES, icon: ICON_LIST_BULLET }, { page: PAGE_PROGRESS, icon: ICON_CHART_BAR }]
...
export const BUTTON_TYPES = [BUTTON_TYPE_SUCCESS, BUTTON_TYPE_WARNING, BUTTON_TYPE_NEUTRAL, BUTTON_TYPE_DANGER, BUTTON_TYPE_PRIMARY]
